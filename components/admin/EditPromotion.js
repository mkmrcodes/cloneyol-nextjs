...
const EditPromotion = ({ data, setShowEdit, getPromotions }) => {
  ...
  const updatePromotion = async (values) => {
    ...
    await axios
      .patch(`${nestApiUrl}/promotions/${data.promotionId}`, body)
      .catch((e) => {
        setIsMsgFail(true);
      ...
      <form className={'border rounded-sm'} onSubmit={handleSubmit(onSubmit)}>
        ...
        >
          ...
          <div className={'text-center'}>
            ...
            >
              {!isMsgSentProgress ? (
                <div className={'text-base font-bold'}>UPDATE PROMOTION</div>
              ) : (
                <div
